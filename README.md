...
curl http://catalog:8081/api/products
curl http://inventory:8081/api/availability/329299
curl http://cart:8081/api/cart/FOO
curl http://rating:8081/api/rating/329299
curl http://review:8081/api/review/329299
```
